...
public class Polymorphism03Main {
	...
	public static void main(String[] args) {
		...
		System.out.println(car2); // ?? toStirng()은 Car의 그것이 동작하는데?
		// 이미 Vehicle 에도 있던 toStirng()을 오버라이딩 한건 사용 가능.
		...
		// 예외는 setOil() 을 호출하는 과정이 아니라, 형변환 하는 과정에서 발생된다s
		
		
		// Java의 최상위 객체 Object 는 모든 객체들을 받을 수 있다.
		Object obj1 = car1;
		Object obj2 = car2;
		Object obj3 = "Hello";
