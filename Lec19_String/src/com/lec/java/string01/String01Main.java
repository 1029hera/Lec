...
public class String01Main {
	...
	public static void main(String[] args) {
		...
		str1 = str1.concat(str2);  // <-- 원본 변경하려면 이와 같이 덮어쓰기
		System.out.println(str1);
		
		// ★주의★
		// empty 문자열과 null 은 다르다
		// null 인 경우 메소드 수행하면 NullPointerException 발생!
		str3 = "";   // empty 문자열.  문자열 객체가 존재는 하나 비어있는 문자열
		System.out.println(str3.length());
...
//		System.out.println(str1.charAt(20));
		...
		if(!url.startsWith(prefix)) {
			System.out.println(prefix.concat(url));
		}
		...
		str4 = "     Hello\t  \n  My \n\n     World";
		strings = str4.split("\\s+");  // 공백 기준으로 쪼개기
		System.out.println(Arrays.toString(strings));
