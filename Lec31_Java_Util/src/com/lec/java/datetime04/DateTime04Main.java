...
public class DateTime04Main {
	...
	public static void main(String[] args) {
		...
		LocalDate date2 = LocalDate.of(1004, 4, 20);
		...
		System.out.println("현재 날짜 시간: " + datetime1);

				
		System.out.println("\nDateTimeFormatter 사용");
		// java.time.DateTimeFormatter 를 사용하여 원하는 포맷으로 출력
		System.out.println("현재날짜시간: " +
					datetime1.format(DateTimeFormatter.ofPattern("yyy-MM-dd HH:mm:ss"))
				);
		
		System.out.println("현재날짜시간: " +
				datetime1.format(DateTimeFormatter.ofPattern("MM월 dd일"))
			);
