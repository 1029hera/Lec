...
public class RockScissorPaper {
	...
	public static void computeResult(int user, int com) {
		...
		case 1:
			...
			else if(com == 2) System.out.println("Com Win!");
			else System.out.println("User Win!");
			break;
		case 2:
			if(com == 1) System.out.println("User Win!");
			else if(com == 2) System.out.println("비겼습니다.");
			else System.out.println("Com Win!");
			break;
		case 3:
			if(com == 1) System.out.println("Com Win!");
			else if(com == 2) System.out.println("User Win!");
